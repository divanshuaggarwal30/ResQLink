...
function IncidentCard({
  ...
  return (
    <button
      ...
      className={`w-full border-b border-slate-800 p-4 text-left transition hover:bg-slate-800/70 ${
        selected
          ? "bg-slate-800"
          : "bg-transparent"
      }`}
              ...
              <div className="flex min-h-[420px] items-center justify-center rounded-2xl border border-dashed border-slate-800 bg-slate-900/30">
                <div className="text-center">
                  ...
                  <p className="mt-2 max-w-sm text-sm text-slate-600">
                    Select an incident from the live feed to view details and dispatch a responder.
                  </p>
                </div>
              </div>
            ) : (
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                  ...
                  <div className="mt-8 grid gap-4 sm:grid-cols-2">
                    <InfoRow
                      icon={MapPin}
                      label="Latitude"
                      value={selectedIncident.latitude.toFixed(6)}
                    />

                    <InfoRow
                      icon={MapPin}
                      label="Longitude"
                      value={selectedIncident.longitude.toFixed(6)}
                    />
                    ...
                    <InfoRow
                      icon={UserRound}
                      label="Incident ID"
                      value={selectedIncident.id.slice(
                        0,
                        8
                      )}
                    />
